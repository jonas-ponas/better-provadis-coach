...
export default function CoachDataTable({data, syncNow, callback}: {data: {[key: string]: any}, syncNow?: boolean, callback?: ()=>void}) {
    ...
    return (
        <TableContainer component={Paper}>
				<Table sx={{ minWidth: 650 }} size='small'>
					<TableHead>
						<TableRow>
							<TableCell colSpan={2} sx={{fontWeight: 'bold'}}>Gespeicherte Coach-Daten</TableCell>
						</TableRow>
					</TableHead>
					<TableBody>
						<TableRow>
						...
						<TableRow>
							...
							<TableCell>
								{(new Date(data?.lastSync)).toLocaleString('de-de')}
							</TableCell>
						</TableRow>
						<TableRow>
