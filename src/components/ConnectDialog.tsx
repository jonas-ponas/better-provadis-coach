...
export default function ConnectDialog(props: { open: boolean; onClose: (success?: boolean) => void }) {
	...
	return (
		...
		<Snackbar open={showSnackbar != undefined} autoHideDuration={10000} onClose={() => setShowSnackbar(undefined)}>
		<Alert variant='filled' onClose={() => setShowSnackbar(undefined)} severity={(showSnackbar?.type||'info') as AlertColor} sx={{ width: '100%' }}>
